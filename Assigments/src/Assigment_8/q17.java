...
public class q17 {
	...
	private static boolean getThunderBlazz(boolean avilable, boolean gift, int ingredient1, int ingredient2,
			int ingredient3) {
		boolean flag = false;
	...
	public static void question() {
		 ...
		 * to mix its ingredients (its a secret formula): 1 from ingredient1,2 from
		 * ingredient2 and 3 from ingredient3. or the alternate recipe: 3 from
		 * ingredient1, 1 from ingredient2 and 2 from ingredient3. this ain't
		 * coca-cola...
		 * 
		 ...
		 * ingredient2, int ingredient3)
		 * 
		 * available = available at store gift = got it as a gift both are booleans.
		 * 
